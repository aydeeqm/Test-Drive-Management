...
function connect(component, store, mapToProps, actions) {
    update();
    var beforeDestroy = component.beforeDestroy;
    ...
    function update() {
        var _a = getDiff(mapToProps(store.getState()), mapToProps(component)), diff = _a.diff, changed = _a.changed;
        if (changed) {
